...
module.exports = {
  ...
  module: {
    ...
    exprContextCritical: false, //HIDE ERROR ON START
  },
  stats: { //HIDE ERROR ON START v2
    warningsFilter: /the request of a dependency is an expression/, //HIDE ERROR ON START v2
  }, //HIDE ERROR ON START v2
  optimization: {
    minimize: false,
